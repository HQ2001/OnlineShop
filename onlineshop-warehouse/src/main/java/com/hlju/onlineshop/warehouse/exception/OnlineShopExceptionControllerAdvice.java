package com.hlju.onlineshop.warehouse.exception;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.hlju.onlineshop.warehouse.controller")
public class OnlineShopExceptionControllerAdvice {
    ...
    public R handleValidateException(UserInputException e) {
